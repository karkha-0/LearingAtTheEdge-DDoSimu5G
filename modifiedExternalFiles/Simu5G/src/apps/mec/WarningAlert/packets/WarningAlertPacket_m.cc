//
// Generated file, do not edit! Created by opp_msgtool 6.1 from modifiedExternalFiles/Simu5G/src/apps/mec/WarningAlert/packets/WarningAlertPacket.msg.
//
...
WarningAppPacket::WarningAppPacket() : ::simu5g::MECPacket()
{
}

WarningAppPacket::WarningAppPacket(const WarningAppPacket& other) : ::simu5g::MECPacket(other)
{
    copy(other);
}
...
WarningAppPacketDescriptor::WarningAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::WarningAppPacket)), "simu5g::MECPacket")
{
...
WarningAlertPacket::WarningAlertPacket() : ::simu5g::WarningAppPacket()
{
}

WarningAlertPacket::WarningAlertPacket(const WarningAlertPacket& other) : ::simu5g::WarningAppPacket(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::simu5g::WarningAppPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::simu5g::WarningAppPacket::parsimPack(b);
...
{
    ::simu5g::WarningAppPacket::parsimUnpack(b);
...
WarningAlertPacketDescriptor::WarningAlertPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::WarningAlertPacket)), "simu5g::WarningAppPacket")
{
    propertyNames = nullptr;
}
...
WarningStartPacket::WarningStartPacket() : ::simu5g::WarningAppPacket()
{
}

WarningStartPacket::WarningStartPacket(const WarningStartPacket& other) : ::simu5g::WarningAppPacket(other)
{
    copy(other);
}
...
WarningStartPacketDescriptor::WarningStartPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::WarningStartPacket)), "simu5g::WarningAppPacket")
{
    propertyNames = nullptr;
}
...
WarningStopPacket::WarningStopPacket() : ::simu5g::WarningAppPacket()
{
}

WarningStopPacket::WarningStopPacket(const WarningStopPacket& other) : ::simu5g::WarningAppPacket(other)
{
    copy(other);
}
...
WarningStopPacketDescriptor::WarningStopPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::WarningStopPacket)), "simu5g::WarningAppPacket")
{
    propertyNames = nullptr;
}
