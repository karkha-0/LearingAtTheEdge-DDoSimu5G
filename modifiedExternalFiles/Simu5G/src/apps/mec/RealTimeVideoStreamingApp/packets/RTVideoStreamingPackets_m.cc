//
// Generated file, do not edit! Created by opp_msgtool 6.1 from modifiedExternalFiles/Simu5G/src/apps/mec/RealTimeVideoStreamingApp/packets/RTVideoStreamingPackets.msg.
//
...
RealTimeVideoStreamingAppPacketDescriptor::RealTimeVideoStreamingAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::RealTimeVideoStreamingAppPacket)), "inet::FieldsChunk")
{
...
StartRealTimeVideoStreamingAppPacket::StartRealTimeVideoStreamingAppPacket() : ::simu5g::RealTimeVideoStreamingAppPacket()
{
}

StartRealTimeVideoStreamingAppPacket::StartRealTimeVideoStreamingAppPacket(const StartRealTimeVideoStreamingAppPacket& other) : ::simu5g::RealTimeVideoStreamingAppPacket(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::simu5g::RealTimeVideoStreamingAppPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::simu5g::RealTimeVideoStreamingAppPacket::parsimPack(b);
...
{
    ::simu5g::RealTimeVideoStreamingAppPacket::parsimUnpack(b);
...
StartRealTimeVideoStreamingAppPacketDescriptor::StartRealTimeVideoStreamingAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::StartRealTimeVideoStreamingAppPacket)), "simu5g::RealTimeVideoStreamingAppPacket")
{
    propertyNames = nullptr;
}
...
StartSessionRealTimeVideoStreamingAppPacket::StartSessionRealTimeVideoStreamingAppPacket() : ::simu5g::RealTimeVideoStreamingAppPacket()
{
}

StartSessionRealTimeVideoStreamingAppPacket::StartSessionRealTimeVideoStreamingAppPacket(const StartSessionRealTimeVideoStreamingAppPacket& other) : ::simu5g::RealTimeVideoStreamingAppPacket(other)
{
    copy(other);
}
...
StartSessionRealTimeVideoStreamingAppPacketDescriptor::StartSessionRealTimeVideoStreamingAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::StartSessionRealTimeVideoStreamingAppPacket)), "simu5g::RealTimeVideoStreamingAppPacket")
{
    propertyNames = nullptr;
}
...
StopSessionRealTimeVideoStreamingAppPacket::StopSessionRealTimeVideoStreamingAppPacket() : ::simu5g::RealTimeVideoStreamingAppPacket()
{
}

StopSessionRealTimeVideoStreamingAppPacket::StopSessionRealTimeVideoStreamingAppPacket(const StopSessionRealTimeVideoStreamingAppPacket& other) : ::simu5g::RealTimeVideoStreamingAppPacket(other)
{
    copy(other);
}
...
StopSessionRealTimeVideoStreamingAppPacketDescriptor::StopSessionRealTimeVideoStreamingAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::StopSessionRealTimeVideoStreamingAppPacket)), "simu5g::RealTimeVideoStreamingAppPacket")
{
    propertyNames = nullptr;
}
...
RealTimeVideoStreamingAppSegmentHeader::RealTimeVideoStreamingAppSegmentHeader() : ::simu5g::RealTimeVideoStreamingAppPacket()
{
}

RealTimeVideoStreamingAppSegmentHeader::RealTimeVideoStreamingAppSegmentHeader(const RealTimeVideoStreamingAppSegmentHeader& other) : ::simu5g::RealTimeVideoStreamingAppPacket(other)
{
    copy(other);
}
...
RealTimeVideoStreamingAppSegmentHeaderDescriptor::RealTimeVideoStreamingAppSegmentHeaderDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::RealTimeVideoStreamingAppSegmentHeader)), "simu5g::RealTimeVideoStreamingAppPacket")
{
    propertyNames = nullptr;
}
