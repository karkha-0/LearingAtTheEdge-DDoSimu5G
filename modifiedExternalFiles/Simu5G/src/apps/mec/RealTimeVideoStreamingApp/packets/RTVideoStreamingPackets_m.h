...
#ifndef __SIMU5G_RTVIDEOSTREAMINGPACKETS_M_H
#define __SIMU5G_RTVIDEOSTREAMINGPACKETS_M_H
...
/**
 * Class generated from <tt>modifiedExternalFiles/Simu5G/src/apps/mec/RealTimeVideoStreamingApp/packets/RTVideoStreamingPackets.msg:19</tt> by opp_msgtool.
 * <pre>
...
/**
 * Class generated from <tt>modifiedExternalFiles/Simu5G/src/apps/mec/RealTimeVideoStreamingApp/packets/RTVideoStreamingPackets.msg:24</tt> by opp_msgtool.
 * <pre>
 ...
 * </pre>
 */
class StartRealTimeVideoStreamingAppPacket : public ::simu5g::RealTimeVideoStreamingAppPacket
{
  protected:
    int fps = 0;
...
/**
 * Class generated from <tt>modifiedExternalFiles/Simu5G/src/apps/mec/RealTimeVideoStreamingApp/packets/RTVideoStreamingPackets.msg:33</tt> by opp_msgtool.
 * <pre>
 ...
 * </pre>
 */
class StartSessionRealTimeVideoStreamingAppPacket : public ::simu5g::RealTimeVideoStreamingAppPacket
{
  protected:
    int fps = 0;
    ::omnetpp::opp_string codec;
...
/**
 * Class generated from <tt>modifiedExternalFiles/Simu5G/src/apps/mec/RealTimeVideoStreamingApp/packets/RTVideoStreamingPackets.msg:40</tt> by opp_msgtool.
 * <pre>
 ...
 * </pre>
 */
class StopSessionRealTimeVideoStreamingAppPacket : public ::simu5g::RealTimeVideoStreamingAppPacket
{
  protected:
    int sessionId = 0;
...
/**
 * Class generated from <tt>modifiedExternalFiles/Simu5G/src/apps/mec/RealTimeVideoStreamingApp/packets/RTVideoStreamingPackets.msg:45</tt> by opp_msgtool.
 * <pre>
 ...
 * </pre>
 */
class RealTimeVideoStreamingAppSegmentHeader : public ::simu5g::RealTimeVideoStreamingAppPacket
{
  protected:
    int headerLength = 4;
    int payloadLength = 0;
...
template<> inline simu5g::RealTimeVideoStreamingAppPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::RealTimeVideoStreamingAppPacket*>(ptr.get<cObject>()); }
template<> inline simu5g::StartRealTimeVideoStreamingAppPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::StartRealTimeVideoStreamingAppPacket*>(ptr.get<cObject>()); }
template<> inline simu5g::StartSessionRealTimeVideoStreamingAppPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::StartSessionRealTimeVideoStreamingAppPacket*>(ptr.get<cObject>()); }
template<> inline simu5g::StopSessionRealTimeVideoStreamingAppPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::StopSessionRealTimeVideoStreamingAppPacket*>(ptr.get<cObject>()); }
template<> inline simu5g::RealTimeVideoStreamingAppSegmentHeader *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::RealTimeVideoStreamingAppSegmentHeader*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __SIMU5G_RTVIDEOSTREAMINGPACKETS_M_H
