...
#ifndef __SIMU5G_REQUESTRESPONSEPACKET_M_H
#define __SIMU5G_REQUESTRESPONSEPACKET_M_H
...
/**
 * Class generated from <tt>modifiedExternalFiles/Simu5G/src/apps/mec/MecRequestResponseApp/packets/RequestResponsePacket.msg:21</tt> by opp_msgtool.
 * <pre>
...
template<> inline simu5g::RequestResponseAppPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::RequestResponseAppPacket*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __SIMU5G_REQUESTRESPONSEPACKET_M_H
