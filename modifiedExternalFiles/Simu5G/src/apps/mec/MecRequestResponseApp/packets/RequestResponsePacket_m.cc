//
// Generated file, do not edit! Created by opp_msgtool 6.1 from modifiedExternalFiles/Simu5G/src/apps/mec/MecRequestResponseApp/packets/RequestResponsePacket.msg.
//
...
RequestResponseAppPacketDescriptor::RequestResponseAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::RequestResponseAppPacket)), "inet::FieldsChunk")
{
