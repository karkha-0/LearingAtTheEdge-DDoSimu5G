//
// Generated file, do not edit! Created by opp_msgtool 6.1 from modifiedExternalFiles/Simu5G/src/apps/mec/DeviceApp/DeviceAppMessages/DeviceAppPacket.msg.
//
...
DeviceAppPacket::DeviceAppPacket() : ::simu5g::MECPacket()
{
}

DeviceAppPacket::DeviceAppPacket(const DeviceAppPacket& other) : ::simu5g::MECPacket(other)
{
    copy(other);
}
...
DeviceAppPacketDescriptor::DeviceAppPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeviceAppPacket)), "simu5g::MECPacket")
{
...
DeviceAppStartPacket::DeviceAppStartPacket() : ::simu5g::DeviceAppPacket()
{
}

DeviceAppStartPacket::DeviceAppStartPacket(const DeviceAppStartPacket& other) : ::simu5g::DeviceAppPacket(other)
{
    copy(other);
}
...
{
    if (this == &other) return *this;
    ::simu5g::DeviceAppPacket::operator=(other);
    copy(other);
    return *this;
}
...
void DeviceAppStartPacket::copy(const DeviceAppStartPacket& other)
{
    ...
    this->associateDevAppId = other.associateDevAppId;
}

void DeviceAppStartPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::simu5g::DeviceAppPacket::parsimPack(b);
    ...
    doParsimPacking(b,this->shared);
    doParsimPacking(b,this->associateDevAppId);
}

void DeviceAppStartPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::simu5g::DeviceAppPacket::parsimUnpack(b);
    ...
    doParsimUnpacking(b,this->shared);
    doParsimUnpacking(b,this->associateDevAppId);
}
...
bool DeviceAppStartPacket::getShared() const
{
    return this->shared;
}

void DeviceAppStartPacket::setShared(bool shared)
{
    handleChange();
    this->shared = shared;
}

int DeviceAppStartPacket::getAssociateDevAppId() const
{
    return this->associateDevAppId;
}

void DeviceAppStartPacket::setAssociateDevAppId(int associateDevAppId)
{
    handleChange();
    this->associateDevAppId = associateDevAppId;
}
...
DeviceAppStartPacketDescriptor::DeviceAppStartPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeviceAppStartPacket)), "simu5g::DeviceAppPacket")
{
    propertyNames = nullptr;
}
...
unsigned int DeviceAppStartPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_shared
        FD_ISEDITABLE,    // FIELD_associateDevAppId
    };
...
int DeviceAppStartPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "shared") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "associateDevAppId") == 0) return baseIndex + 5;
    return base ? base->findField(fieldName) : -1;
}
...
std::string DeviceAppStartPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_shared: return bool2string(pp->getShared());
        case FIELD_associateDevAppId: return long2string(pp->getAssociateDevAppId());
        default: return "";
    }
}
...
void DeviceAppStartPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_shared: pp->setShared(string2bool(value)); break;
        case FIELD_associateDevAppId: pp->setAssociateDevAppId(string2long(value)); break;
...
omnetpp::cValue DeviceAppStartPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_shared: return pp->getShared();
        case FIELD_associateDevAppId: return pp->getAssociateDevAppId();
...
void DeviceAppStartPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_shared: pp->setShared(value.boolValue()); break;
        case FIELD_associateDevAppId: pp->setAssociateDevAppId(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'DeviceAppStartPacket'", field);
    }
}
...
DeviceAppStopPacket::DeviceAppStopPacket() : ::simu5g::DeviceAppPacket()
{
}

DeviceAppStopPacket::DeviceAppStopPacket(const DeviceAppStopPacket& other) : ::simu5g::DeviceAppPacket(other)
{
    copy(other);
}
...
DeviceAppStopPacketDescriptor::DeviceAppStopPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeviceAppStopPacket)), "simu5g::DeviceAppPacket")
{
    propertyNames = nullptr;
}
...
DeviceAppStartAckPacket::DeviceAppStartAckPacket() : ::simu5g::DeviceAppPacket()
{
}

DeviceAppStartAckPacket::DeviceAppStartAckPacket(const DeviceAppStartAckPacket& other) : ::simu5g::DeviceAppPacket(other)
{
    copy(other);
}
...
DeviceAppStartAckPacketDescriptor::DeviceAppStartAckPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeviceAppStartAckPacket)), "simu5g::DeviceAppPacket")
{
    propertyNames = nullptr;
}
...
DeviceAppStopAckPacket::DeviceAppStopAckPacket() : ::simu5g::DeviceAppPacket()
{
}

DeviceAppStopAckPacket::DeviceAppStopAckPacket(const DeviceAppStopAckPacket& other) : ::simu5g::DeviceAppPacket(other)
{
    copy(other);
}
...
DeviceAppStopAckPacketDescriptor::DeviceAppStopAckPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(simu5g::DeviceAppStopAckPacket)), "simu5g::DeviceAppPacket")
{
    propertyNames = nullptr;
}
